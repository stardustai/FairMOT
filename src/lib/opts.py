...
class opts(object):
    def __init__(self):
        ...
        # system
        self.parser.add_argument('--gpus', default='0',  # default='2, 3',
        ...
        self.parser.add_argument('--lr_step', type=str, default='10,20,25',
                                 help='drop learning rate by 10.')
        self.parser.add_argument('--lr_decay', type=float, default=0.5,
                                 help='drop learning rate by 10.')
        ...
        self.parser.add_argument(
            '--data_dir', type=str, default='/home/zyf/dataset')
        ...
        self.parser.add_argument('--multi_loss', default='uncertainty',
